...
python -W ignore ..\test.py ^
    ...
    --cpu > .\log\adapter-5-random\superblue11_test.log 2>&1
if %errorlevel% == 0 (
...
python -W ignore ..\test.py ^
    ...
    --ann_file_test ..\data\target_datasets\superblue12.csv ^
    --dataset_type SuperBlueDataset ^
    --cpu > .\log\adapter-5-random\superblue14_test.log 2>&1
if %errorlevel% == 0 (
...
python -W ignore ..\test.py ^
    ...
    --ann_file_test ..\data\target_datasets\superblue12.csv ^
    --dataset_type SuperBlueDataset ^
    --cpu > .\log\adapter-5-random\superblue16_a_test.log 2>&1
if %errorlevel% == 0 (
...
python -W ignore ..\test.py ^
    ...
    --ann_file_test ..\data\target_datasets\superblue12.csv ^
    --dataset_type SuperBlueDataset ^
    --cpu > .\log\adapter-5-random\superblue19_test.log 2>&1
if %errorlevel% == 0 (
